      ...
      {mobileOpen && (
        <div className="md:hidden border-t border-white/10 px-5 py-5" style={{ background: "var(--teal-mid)" }}>
          ...
          <div className="border-t border-white/10 mt-4 pt-4 space-y-0.5">
            ...
            <Link href="/holiday" onClick={closeAll} className="flex items-center gap-3 px-3 py-3 rounded-xl text-sm font-semibold text-white/80 hover:text-white hover:bg-white/10 transition-colors">
              <span>🎄</span> Holidays
            </Link>
